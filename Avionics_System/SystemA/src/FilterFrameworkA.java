...
* in order to be considered valid system filters. Filters as stand alone threads until the inputport no longer
...
public class FilterFrameworkA extends Thread
{
	...
	private FilterFrameworkA InputFilter;
	...
	****************************************************************************/
	...
	void Connect( FilterFrameworkA Filter )
	{
		try
		{
