...
public class PlumberSysB
{
	public static void main(String args[])
   {
		...
		****************************************************************************/
		...
		SourceFilterSysB Filter1 = new SourceFilterSysB();
		MiddleFilterSysB Filter2 = new MiddleFilterSysB();
		SinkFilterSysB Filter3 = new SinkFilterSysB();
