...
* Project: System B
* Versions:
*	1.0 November 2016 - SystemA Source Filter code
*
* Description:
* This class reads the source file and extends the functionality of FiterFramework.
* The super class provides the functions to read and writing output.
* The thread executes run function which contains the code to read the source file "FlightData.dat" 
* @author Krishna
**************************************************************/
public class SourceFilterSysB extends FilterFrameworkSysB{
